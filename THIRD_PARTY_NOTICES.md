...
- Pinned version in the Docker image: 2026.08.19
- Source: https://github.com/yt-dlp/yt-dlp

## FFmpeg

- Project: FFmpeg
- Installed from the Debian package repository used by the runtime image
- Source: https://ffmpeg.org/

See each upstream project for its complete license terms and notices.
